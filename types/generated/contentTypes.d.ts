...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['AI', 'HEALTHCARE', 'CORE', 'HUMAN SCIENCES']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['test1', 'test2', 'test3']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeronewHeronew extends Struct.CollectionTypeSchema {
  collectionName: 'heronews';
  info: {
    description: '';
    displayName: 'heronew';
    pluralName: 'heronews';
    singularName: 'heronew';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMediaphotoMediaphoto extends Struct.CollectionTypeSchema {
  collectionName: 'mediaphotos';
  info: {
    description: '';
    displayName: 'mediaphoto';
    pluralName: 'mediaphotos';
    singularName: 'mediaphoto';
  };
  options: {
    draftAndPublish: true;
  };
